...
def test_label_conversion():
    ...
    assert len(converted_labels) == len(labels), "Converted labels list should have the same length as the input labels list."
    ...
    for label in converted_labels:
        ...
        elif label in ["zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"]:
            language_counts["english"] += 1
        elif label in ["null", "eins", "zwei", "drei", "vier", "fünf", "sechs", "sieben", "acht", "neun"]:
