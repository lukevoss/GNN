...
hyperparams = {"hidden_size": hidden_size, "n_blocks": n_blocks, "epochs": epochs}

wandb_logger = WandbLogger(
    project="cINN-Image-Inpainting", entity="network-to-network", name="128_20b_inp64"
)  # optionally pass in run name with: name="test-run"
